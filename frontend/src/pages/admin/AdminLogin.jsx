...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6" style={{ backgroundColor: '#FAF9F6' }}>
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg w-full max-w-md border border-gray-200">
        <div className="text-center mb-6 sm:mb-8">
          ...
          >
            <Lock className="w-6 h-6 sm:w-8 sm:h-8" style={{ color: '#8B6F8E' }} />
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold mb-2" style={{ color: '#8B6F8E' }}>Admin Login</h1>
